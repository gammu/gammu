...
latex_documents = [
    (
        ...
        "gammu.tex",
        r"Gammu Manual",
        r"Michal Čihař <michal@cihar.com>",
        "manual",
        True,
    ),
    (
...
man_pages = [
    ...
    (
        "smsd/tables",
        "gammu-smsd-tables",
        "description of tables for database backends of gammu-smsd(1)",
        "Michal Čihař <michal@cihar.com>",
        7,
    ),
    (
    ...
    (
        "formats/smsbackup",
        "gammu-smsbackup",
        "gammu(1) SMS backup file format.",
        "Michal Čihař <michal@cihar.com>",
        5,
    ),
    (
