// PhoneBook_DLL.cpp : Defines the initialization routines for the DLL.
//
...
// DLL CONTRUCT
void CPhoneBookApp::LoadStringSetting()
{
	...
	//get module path
	al_GetModulePath(m_hInstance,theApp.m_szModule);
