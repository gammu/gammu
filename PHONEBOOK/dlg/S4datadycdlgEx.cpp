...
CS4DataDycDlgEx::CS4DataDycDlgEx(CWnd* pParent /*=NULL*/)
	: CBaseDlg(IDD_DATA_DYC_S4_EX, pParent)
{
	//{{AFX_DATA_INIT(CS4DataDycDlgEx)
	//}}AFX_DATA_INIT
	m_hFont = NULL;
...
CS4DataDycDlgEx::~CS4DataDycDlgEx()
{
	RemoveInfoList();
	if(m_hFont)
		::DeleteObject(m_hFont);
}
void CS4DataDycDlgEx::RemoveInfoList()
{
...
void CS4DataDycDlgEx::DoDataExchange(CDataExchange* pDX)
{
	CBaseDlg::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CS4DataDycDlgEx)
	...
	DDX_Control(pDX, IDC_SC_NUMBER13, m_scNum13);
	...
	DDX_Control(pDX, IDC_SC_S6DOT13, m_scDot13);
...
BEGIN_MESSAGE_MAP(CS4DataDycDlgEx, CBaseDlg)
	//{{AFX_MSG_MAP(CS4DataDycDlgEx)
...
/////////////////////////////////////////////////////////////////////////////
// CS4DataDycDlgEx message handlers


void CS4DataDycDlgEx::OnCheckBtn(UINT nID) 
{
	BOOL bEnable = false;
	if(nID == IDC_S6_CHECK12)
	{
	...
	else
	{
		...
		if(nIndex >=4)
		{
			...
			case 5:
				...
				break;
			case 6:
				UpdateTextComboBox(&m_cb10,&m_cb9,&m_cb11);
				break;
			}
		}
...
/*	m_edCompany.GetWindowText(szTxt,MAX_PATH);
	...
	if(iIndex == 4){	//combobox 4
		GSM_EntryType entryTye =(GSM_EntryType)(m_cb4.GetItemData(m_cb4.GetCurSel()));
...
/*		switch(m_cb3.GetCurSel())
		...
		if(pCh[iIndex - 5]->IsWindowEnabled() && pCh[iIndex - 5]->GetCheck())
		{
			GSM_EntryType entryTye =(GSM_EntryType)(pCb[iIndex - 5]->GetItemData(pCb[iIndex - 5]->GetCurSel()));
			data.SetType(entryTye);
/*
			...
			pEd[iIndex - 5]->GetWindowText(szTxt,MAX_PATH);
		}
	}
	data.SetText(szTxt);
	deqData.push_back(data);
...
void CS4DataDycDlgEx::OnRdMobile() 
{
	m_rdSIM.SetCheck(0);
	m_rdME.SetCheck(1);	
...
void CS4DataDycDlgEx::OnSelchangeCombo10() 
{
...
void CS4DataDycDlgEx::OnSelchangeCombo4() 
{
	// TODO: Add your control notification handler code here
	xSetSupportColumnLength();
	xSetDefaultCombo();	
...
void CS4DataDycDlgEx::OnSelchangeCombo5() 
{
	// TODO: Add your control notification handler code here
	xSetSupportColumnLength();
	xSetDefaultCombo();	
...
void CS4DataDycDlgEx::OnSelchangeCombo6() 
{
	// TODO: Add your control notification handler code here
	xSetSupportColumnLength();
	xSetDefaultCombo();	
...
void CS4DataDycDlgEx::OnSelchangeCombo7() 
{
	// TODO: Add your control notification handler code here
	xSetSupportColumnLength();
	xSetDefaultCombo();	
...
void CS4DataDycDlgEx::OnSelchangeCombo8() 
{
	// TODO: Add your control notification handler code here
	xSetSupportColumnLength();
	xSetDefaultCombo();	
...
void CS4DataDycDlgEx::OnSelchangeCombo9() 
{
	// TODO: Add your control notification handler code here
	xSetSupportColumnLength();
...
BOOL CS4DataDycDlgEx::OnInitDialog() 
{
	...
	sProfile += Tstring(_T("organize\\S4DataDycDlgEx.ini"));
	//load static
	CStaticEx *pStaticEx[32] = {&m_scTitle,&m_scLastName,&m_scFirstName,&m_scStorage,
		&m_scNum1,&m_scNum2,&m_scNum3,&m_scNum4,&m_scNum5,&m_scNum6,&m_scNum7,&m_scNum8,&m_scNum9,&m_scNum10,&m_scNum11,&m_scNum12,&m_scNum13,
		&m_scDot1,&m_scDot2,&m_scDot3,&m_scDot4,&m_scDot5,&m_scDot6,&m_scDot7,&m_scDot8,&m_scDot9,&m_scDot10,&m_scDot11,&m_scDot12,&m_scDot13,
		&m_scDefault,&m_scBirthday};
	TCHAR szScSec[32][32] = {_T("title_sc"),_T("lastname_sc"),_T("firstname_sc"),_T("storage_sc"),
		_T("num1_sc"),_T("num2_sc"),_T("num3_sc"),_T("num4_sc"),_T("num5_sc"),_T("num6_sc"),_T("num7_sc"),_T("num8_sc"),_T("num9_sc"),_T("num10_sc"),_T("num11_sc"),_T("num12_sc"),_T("num13_sc"),
		_T("dot1_sc"),_T("dot2_sc"),_T("dot3_sc"),_T("dot4_sc"),_T("dot5_sc"),_T("dot6_sc"),_T("dot7_sc"),_T("dot8_sc"),_T("dot9_sc"),_T("dot10_sc"),_T("dot11_sc"),_T("dot12_sc"),_T("dot13_sc"),
		_T("default_sc"),_T("birthday_sc")};
	TCHAR szScID[32][32] = {_T(""),_T("IDS_N_LASTNAME"),_T("IDS_N_FIRSTNAME"),_T("IDS_STORAGE"),
		_T("IDS_1"),_T("IDS_2"),_T("IDS_3"),_T("IDS_4"),_T("IDS_5"),_T("IDS_6"),_T("IDS_7"),_T("IDS_8"),_T("IDS_9"),_T("IDS_10"),_T("IDS_11"),_T("IDS_12"),_T("IDS_13"),
		_T("IDS_DOT"),_T("IDS_DOT"),_T("IDS_DOT"),_T("IDS_DOT"),_T("IDS_DOT"),_T("IDS_DOT"),_T("IDS_DOT"),_T("IDS_DOT"),_T("IDS_DOT"),_T("IDS_DOT"),_T("IDS_DOT"),_T("IDS_DOT"),_T("IDS_DOT"),
		_T("IDS_SETDEFAULT"),_T("IDS_N_BIRTHDAY")};
	if(m_iMode == 0)
	...
	CWnd *pWnd[22] = {&m_cb3,&m_cb4,&m_cb5,&m_cb6,&m_cb7,&m_cb8,&m_cb9,&m_cb10,&m_cb11,&m_cbDefault,
		&m_edLastName,&m_edFirstName,&m_ed3,
		&m_ed4,&m_ed5,&m_ed6,&m_ed7,&m_ed8,&m_ed9,&m_ed10,&m_ed11,&m_dpBirthday};
	TCHAR szWndSec[22][32] = {_T("cb3"),_T("cb4"),_T("cb5"),_T("cb6"),_T("cb7"),_T("cb8"),_T("cb9"),_T("cb10"),_T("cb11"),_T("default_cb"),
...
void CS4DataDycDlgEx::xSetDefaultCombo()
{
...
/*
void CS4DataDycDlgEx::SetMode(int iMode)
{
	m_iMode = iMode;
}

void CS4DataDycDlgEx::SetData(CCardPanel *pData)
{
	m_pData = pData;
}

void CS4DataDycDlgEx::SetIsME(int iFlag)
{
	m_iIsME = iFlag;
}
*/
void CS4DataDycDlgEx::xSetDataToDlgCtrl()
{
	//set name
/*	TCHAR szName[MAX_PATH];
	...
	/*	else if((*iter).GetType() == PBK_Text_Company){	//company
		...
		if(bFindType == false)
		{
			...
			if(bFindType)
			{
				...
				{
					int j =0;
					for(j = 0 ; j<m_cb9.GetCount() ;j++)
					{
						 if(PBK_Text_Postal == (GSM_EntryType)(m_cb9.GetItemData(j)) && iData < 3)
						 {
							//get control
...
void CS4DataDycDlgEx::xSetComboItem()
{
...
void CS4DataDycDlgEx::xGetUnusedControl(int iIndex, CCheckEx **pCh, CComboBox **pCb, CMyEdit **pEdit)
{
	switch(iIndex){
	case 0:	//combo3
		*pCh = NULL;
...
void CS4DataDycDlgEx::xSetDefaultControl()
{
	m_cb3.SetCurSel(0);
...
void CS4DataDycDlgEx::xSetDefaultEnableControl()
{
	CCheckEx *pCh[7] = {&m_ch5,&m_ch6,&m_ch7,&m_ch8,&m_ch9,&m_ch10,&m_ch11};
	CComboBox *pCb[7] = {&m_cb5,&m_cb6,&m_cb7,&m_cb8,&m_cb9,&m_cb10,&m_cb11};
	CMyEdit *pEd[7] = {&m_ed5,&m_ed6,&m_ed7,&m_ed8,&m_ed9,&m_ed10,&m_ed11};
...
*/
void CS4DataDycDlgEx::xEnableControl(int iIndex, BOOL bFlag)
{
	...
	CCheckEx *pCh[7] = {&m_ch5,&m_ch6,&m_ch7,&m_ch8,&m_ch9,&m_ch10,&m_ch11};
	CComboBox *pCb[7] = {&m_cb5,&m_cb6,&m_cb7,&m_cb8,&m_cb9,&m_cb10,&m_cb11};
	CEdit *pEd[7] = {&m_ed5,&m_ed6,&m_ed7,&m_ed8,&m_ed9,&m_ed10,&m_ed11};
	...
	if(iIndex == 0){	//name
		...
		m_cb4.EnableWindow(bFlag);
		m_ed4.EnableWindow(bFlag);
	}
	else if(iIndex == 11){
		m_ch12.EnableWindow(bFlag);
		if(bFlag == TRUE)
		{
			if(m_ch12.GetCheck())
		...
		if(bFlag == TRUE){
			if(pCh[iIndex - 4]->GetCheck()){
				pCb[iIndex - 4]->EnableWindow(bFlag);
				pEd[iIndex - 4]->EnableWindow(bFlag);
			}
		}
		else{
			pCb[iIndex - 4]->EnableWindow(bFlag);
...
void CS4DataDycDlgEx::xSetSupportColumnLength()
{
...
int CS4DataDycDlgEx::xGetComboSel(int iIndex)
{
...
void CS4DataDycDlgEx::xSetCombo2Item()
{
	if(m_rdSIM.GetCheck())
	{
		for(int i = m_cb4.GetCount()-1 ; i > 0 ; i --)
...
/*
		...
		if(al_GetSettingInt(_T("NumberCombo"),_T("Count"),szProfile,nCount) && nCount>0)
		{
			for(i = 1; i<=nCount ;i++)
			{
				...
				al_GetSettingString(_T("public"),szStringID,theApp.m_szRes,szComboString);
				index = m_cb4.AddString(szComboString);
				m_cb4.SetItemData(index,entryType);
			}
...
void CS4DataDycDlgEx::UpdateTextComboBox(CComboBox* pCombo1,CComboBox* pCombo2,CComboBox* pNeedUpdateCombo)
{
	int i,nCount = 0;
	TCHAR szProfile[MAX_PATH];
	wsprintf(szProfile,_T("%s%s_%s.ini"),theApp.m_szSkin,_T("organize\\S4Combo"),theApp.m_szPhone);
...
void CS4DataDycDlgEx::OnDropdownS6Combo11() 
{
	// TODO: Add your control notification handler code here
	UpdateTextComboBox(&m_cb9,&m_cb10,&m_cb11);
}

void CS4DataDycDlgEx::OnDropdownS6Combo10() 
{
	// TODO: Add your control notification handler code here
	UpdateTextComboBox(&m_cb9,&m_cb11,&m_cb10);
...
void CS4DataDycDlgEx::OnDropdownS6Combo9() 
{
	// TODO: Add your control notification handler code here
	UpdateTextComboBox(&m_cb10,&m_cb11,&m_cb9);
	
}
void CS4DataDycDlgEx::OnDropdownS6Combo3() 
{
	// TODO: Add your control notification handler code here
	GSM_EntryType SelEntryType =(GSM_EntryType) m_cb3.GetItemData(m_cb3.GetCurSel());
	POSITION pos = m_InfoList.GetHeadPosition();
...
void CS4DataDycDlgEx::OnSetfocusS6Edit9() 
{
	// TODO: Add your control notification handler code here
...
void CS4DataDycDlgEx::OnSetfocusS6Edit10() 
{
	// TODO: Add your control notification handler code here
	static bInAddressdlg = false;
...
void CS4DataDycDlgEx::OnSetfocusS6Edit11() 
{
	// TODO: Add your control notification handler code here
	static bInAddressdlg = false;
...
BOOL CS4DataDycDlgEx::IsFocusOnAddressEdit(CComboBox* pCombo)
{
...
void CS4DataDycDlgEx::EditAddress(CMyEdit* pEdit)
{
//	CString strAddress;
...
void CS4DataDycDlgEx::OnSelchangeCombo3() 
{
	// TODO: Add your control notification handler code here
	xSetSupportColumnLength();
	GSM_EntryType SelEntryType =(GSM_EntryType) m_cb3.GetItemData(m_cb3.GetCurSel());
...
void CS4DataDycDlgEx::OnSelchangeCombo11() 
{
	// TODO: Add your control notification handler code here
	xSetSupportColumnLength();
}
