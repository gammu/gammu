...
.. c:function:: GSM_Error	GSM_SMSDService::RefreshSendStatus (GSM_SMSDConfig
*Config, char *ID)
...
.. c:function:: GSM_Error	GSM_SMSDService::ReadConfiguration (GSM_SMSDConfig
*Config)
...
The lifetime of ID for sent message:
    ...
    * :c:func:`GSM_SMSDService::MoveSMS` then moves the message based on ID
      to sent items
