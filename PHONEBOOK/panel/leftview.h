...
public:
	...
	void SetConnectFlag(bool bFlag){m_bConnect = bFlag;}
	void SetDLFailFlag(bool bFlag){m_bDLFail = bFlag;}
...
protected:
	...
	afx_msg HRESULT OnLoadMSOTTree(WPARAM wParam,LPARAM lParam);
	DECLARE_MESSAGE_MAP()
};
