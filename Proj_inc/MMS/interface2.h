...
typedef struct ATTACHINFOTag
{
	char             *pAttachfilename;
	char             *pAttachDisplayname;
	char				*pAttachType;
}ATTACHINFO;
...
typedef struct AfMMSEDITTag
{
      ...
      char           *pBccAddr;  /*recipients's copy address*/
      char           *pSubject;
	  ...
	  int			 nAttachNum;
	  ATTACHINFO	 AttachInfo[MAX_ATTACH_NUM];
} MMSEDIT;
