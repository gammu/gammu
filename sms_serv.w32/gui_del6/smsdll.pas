...
function GSM_DetectDevice		(Device	: PChar; Connection: PChar; LogFile: PChar; LogFileType: PChar): GSM_Error; stdcall; external 'smsdll.dll' name 'mydetectdevice';
function GSM_GetNetworkInfo	        (Phone : integer; NetworkInfo : PGSM_NetworkInfo): GSM_Error; stdcall; external 'smsdll.dll' name 'mygetnetworkinfo';
function GSM_GetSMSStatus	        (Phone : integer; status : PGSM_SMSMemoryStatus): GSM_Error; stdcall; external 'smsdll.dll' name 'mygetsmsstatus';
function GSM_GetNextSMSMessage	        (Phone : integer; SMS : PGSM_MultiSMSMessage;start : Boolean): GSM_Error; stdcall; external 'smsdll.dll' name 'mygetnextsmsmessage';
function GSM_DeleteSMSMessage	        (Phone : integer; SMS : PGSM_SMSMessage): GSM_Error; stdcall; external 'smsdll.dll' name 'mydeletesmsmessage';
function GSM_SendSMSMessage	        (Phone : integer; SMS : PGSM_SMSMessage;timeout:integer): GSM_Error; stdcall; external 'smsdll.dll' name 'mysendsmsmessage';
function GSM_SaveSMSMessage	        (Phone : integer; SMS : PGSM_SMSMessage): GSM_Error; stdcall; external 'smsdll.dll' name 'mysavesmsmessage';
function GSM_EnterSecurityCode	        (Phone : integer; Code : PGSM_SecurityCode): GSM_Error; stdcall	; external 'smsdll.dll' name 'myentersecuritycode';
function GSM_GetIMEI	                (Phone : integer; IMEI:PAnsiString): GSM_Error; stdcall; external 'smsdll.dll' name 'mygetimei';
function GSM_GetManufacturer	        (Phone : integer; IMEI:PAnsiString): GSM_Error; stdcall; external 'smsdll.dll' name 'mygetmanufacturer';
function GSM_GetModel	                (Phone : integer; Model:PAnsiString): GSM_Error; stdcall; external 'smsdll.dll' name 'mygetmodel';
function GSM_GetFirmwareVersion         (Phone : integer; Version: PDouble): GSM_Error; stdcall; external 'smsdll.dll' name 'mygetfirmwareversion';
function GSM_Reset                      (Phone : integer; Hard: Boolean): GSM_Error; stdcall; external 'smsdll.dll' name 'myreset';
function GSM_Initialize		        (Phone : Pinteger; Device: PChar;Connection: PChar; Model : PChar; LogFile: PChar; LogFileType: PChar; CallBack1 : PhoneCallBackProc; CallBack2: SecurityCallBackProc; CallBack3: SMSCallBackProc): GSM_Error; stdcall; external 'smsdll.dll' name 'myinitialize';
procedure GSM_GetNetworkName	        (NetworkCode: PAnsiString; NetworkName: PAnsiString); stdcall; external 'smsdll.dll' name 'mygetnetworkname';
procedure GSM_GetGammuVersion		(Version: PAnsiString); stdcall; external 'smsdll.dll' name 'mygetgammuversion';
...
begin
        ...
        Dest[i] := 0;
        GetGammuUnicodeString := WideCharLenToString(@Dest,i);
end;
