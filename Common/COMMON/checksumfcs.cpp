...
{
  	fcs32_init(uFcs32);// step 1
	fcs32_update(uFcs32, pBuffer, uBufSize); // step 2
	fcs32_final(uFcs32);// step 3 ; return checksum = m_fcs32
}
void checksum_fcs16(unsigned short *uFcs16,unsigned char *pBuffer, unsigned long uBufSize)
{
  	fcs16_init(uFcs16);// step 1
	fcs16_update(uFcs16, pBuffer, uBufSize); // step 2
	fcs16_final(uFcs16);// step 3 ; return checksum = m_fcs32
}
