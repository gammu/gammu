...
// Modified by Mingfa ; 0125
typedef struct
{
  char MMS;        //MMS
  char SMS;        //SMS
  char EMS;        //Add by Mingfa , 0125
  char Photo;      // PHOTO => File Manager Flag
  char Ringtone;   // RINGTONE
  char Video;      // VIDEO
  char PhoneBook;  // PhoneBook  // Change Schedule to PhoneBook by Mingfa , 0125
  char Calendar;   // Calendar
  char Memo;       // Added by Mingfa , 0125
  char Todolist;   // Todolist ( Work)
  char Mail;       // Added by Mingfa , 0125
  char Sync;	   // Sync
  char BackupRestore; // Added by Mingfa , 0125 
  char DownloadJava; // Added by Mingfa , 0125
  char GPRS;         // Added by Mingfa , 0422
  char PhotoManager; // For Photo only ; Added by Mingfa , 0425
...
//Compare; added by mingfa , v1.0.2.1
