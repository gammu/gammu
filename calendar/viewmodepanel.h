...
//Calendar
#define _CalendarMode_ 
//#undef _CalendarMode_ 

#ifdef _CalendarMode_
#define VIEWMODE_TBN_NUM 4
#else 
#define VIEWMODE_TBN_NUM 3
#endif
//Calendar
...
{
public:
	void EnableDailyWeeklyMonthlyView(BOOL bEnable);
	CViewModePanel();
...
protected:
	...
	CTabButtonEx2  m_tbIcon;
	CTabButtonEx2  m_tbList;//nono
