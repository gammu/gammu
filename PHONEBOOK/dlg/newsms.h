...
public:
	...
	int		HasHighByte(CString szString);
...
//	int		InitializeFromString(LPCSTR pstrString);
	...
	HBRUSH	m_hBrush;
//	char	m_strGetMsg[MAX_CONTENT+2];
	CString m_strGetMsg;
...
public:
	void		SetData(SMS_PARAM msgInfo, int nReply, bool bFirstCall);
	void		SetPhoneNo(CString PhoneList);
