 ...
 * \ingroup Callback
 */
typedef void (*IncomingUSSDCallback) (GSM_StateMachine *s, GSM_USSDMessage ussd);
 ...
 * \ingroup Callback
 */
typedef void (*SendSMSStatusCallback) (GSM_StateMachine *s, int status, int MessageReference);
