...
inboxformat = $INBOXF
transmitformat = auto
includenumbersfile = /home/runner/work/gammu/gammu/_build/smsd/smsd-test-$SERVICE/include.lst
EOT
cat > include.lst <<EOT
800123456
EOT
...
# Inject messages
cp /home/runner/work/gammu/gammu/smsd/tests/OUT* /home/runner/work/gammu/gammu/_build/smsd/smsd-test-$SERVICE/outbox/
...
if [ `wc -l < /home/runner/work/gammu/gammu/_build/smsd/smsd-test-$SERVICE/received.log` -ne 3 ] ; then
