...
void single_check(const char *string, int vendor_match, int product_match, int bus_match, int deviceid_match)
{
...
int main(int argc UNUSED, char **argv UNUSED)
{
	...
	single_check("0x1234:0x5678", 0x1234, 0x5678, -1, -1);
	single_check("1234:5678", 1234, 5678, -1, -1);
	single_check("0x1234:-1", 0x1234, -1, -1, -1);
	single_check("1.10", -1, -1, 1, 10);
	single_check("10", -1, -1, -1, 10);
