...
if [ "x1" = x1 ] ; then
    SMSD_EXTRA_PARAMS="-p /home/runner/work/gammu/gammu/_codeql_build_dir/smsd/smsd-test-$SERVICE/smsd.pid"
fi
...
driver = sqlite3
database = smsd.db
dbdir = /home/runner/work/gammu/gammu/_codeql_build_dir/smsd/smsd-test-$SERVICE/
EOT
        ;;
    dbi-pgsql)
        cat >> .smsdrc <<EOT
...
env >> /home/runner/work/gammu/gammu/_codeql_build_dir/smsd/smsd-test-$SERVICE/env.log
...
case $SERVICE in
    ...
    *mysql|odbc)
        ...
        ;;
    files*)
        cp /home/runner/work/gammu/gammu/smsd/tests/OUT+4201234567890.txt /home/runner/work/gammu/gammu/_codeql_build_dir/smsd/smsd-test-$SERVICE/outbox/
        ;;
esac
...
if [ `wc -l < /home/runner/work/gammu/gammu/_codeql_build_dir/smsd/smsd-test-$SERVICE/received.log` -ne $((8 + $INCOMING_USSD)) ] ; then
    echo "ERROR: Wrong number of messages received!"
    exit 1
fi

if ! grep -q -F 'MMS_ADDRESS=http://mmscz/?m=m5da5a9jn210ma56q20' /home/runner/work/gammu/gammu/_codeql_build_dir/smsd/smsd-test-$SERVICE/env.log ; then
    echo "ERROR: Wrong MMS message received!"
    exit 1
fi

if [ $INCOMING_USSD -gt 0 ] && ! grep -q -F 'Reply for *127*1#' /home/runner/work/gammu/gammu/_codeql_build_dir/smsd/smsd-test-$SERVICE/env.log ; then
