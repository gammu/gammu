...
char *GSM_GetNetworkName(char *NetworkCode)
{
	...
	EncodeUnicode(retval, GSM_Networks[index].Name, strlen(GSM_Networks[index].Name));
...
char *GSM_GetNetworkCode(char *NetworkName)
{
	...
	while (strcmp(GSM_Networks[index].Name, DecodeUnicodeString(NetworkName)) &&
		strcmp(GSM_Networks[index].Code, "undefined")) index++;
...
char *GSM_GetCountryName(char *CountryCode)
{
	...
	EncodeUnicode(retval, GSM_Countries[index].Name, strlen(GSM_Countries[index].Name));
...
char *GSM_GetCountryCode(char *CountryName)
{
	...
	while (strcmp(GSM_Countries[index].Name, DecodeUnicodeString(CountryName)) &&
		strcmp(GSM_Countries[index].Code, "undefined")) index++;
