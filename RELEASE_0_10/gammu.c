...
StateMachine_AddCategory(StateMachineObject *self, PyObject *args, PyObject *kwds) {
    ...
    if (UnicodeLength(name) > GSM_MAX_CATEGORY_NAME_LENGTH) {
        printf("Warning: Category name too long, truncating to %d (from %d)\n", GSM_MAX_CATEGORY_NAME_LENGTH, UnicodeLength(name));
...
"SetSMS(Value)\n\n"
"Sets SMS. Returns tuple for location and folder."
;
...
"AddSMS(Value)\n\n"
"Adds SMS to specified folder. Returns tuple for location and folder."
;
...
"DialVoice(Number, ShowNumber = None)\n\n"
"Dials number and starts voice call.\n"
"ShowNumber identifies whether to enable CLIR (None = keep default phone settings)."
;
...
"GetFolderListing(Folder, Start = False)\n\n"
...
"SetFileAttributes(Filename, ReadOnly = False, Protected = False, System = False, Hidden = False)\n\n"
...
"Adds folder to filesystem. Returns new folder ID."
;
...
"SetDebugFile(File)\n\n"
"Sets global debug file. You can pass None (no file), file object or filename."
;
...
"SaveRingtone(File, Ringtone, Format)\n\n"
"Saves ringtone into file. Format can be one of 'ott', 'mid', 'rng', 'imy', 'wav', 'rttl'"
;

static PyObject *
gammu_SaveRingtone(PyObject *self, PyObject *args, PyObject *kwds)
{
    static char                 *kwlist[] = {"File", "Ringtone", "Format", NULL};
    PyObject                    *value;
    PyObject                    *file;
    char                        *s;
    char                        *name;
...
"SaveBackup(Filename, Backup, UseUnicode = True)\n\n"
...
{
    static char                 *kwlist[] = {"File", "Backup", "UseUnicode", NULL};
    PyObject                    *value;
    char                        *filename;
    GSM_Backup                  backup;
    GSM_Error                   error;
...
{
    static char                 *kwlist[] = {"File", "Backup", NULL};
    PyObject                    *value;
    char                        *filename;
