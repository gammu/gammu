...
IF (POSTGRES_INCLUDE_DIR AND POSTGRES_LIBRARY)
    ...
    CHECK_LIBRARY_WORKS("libpq-fe.h" "${POSTGRES_INCLUDE_DIR}" "${POSTGRES_LIBRARY}" "POSTGRES_WORKS")
...
ELSE (POSTGRES_FOUND)
   ...
   #SET (POSTGRES_LIBRARY "")
      ...
      MESSAGE(STATUS "NOT Found PostgreSQL: ${POSTGRES_INCLUDE_DIR}, ${POSTGRES_LIBRARY}")
